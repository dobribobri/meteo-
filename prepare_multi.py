...
if __name__ == '__main__':
    ...
    dump(_obj=np.asarray(TIMESTAMPS), _name='ts', _dump_options=['numpy'])
    dump(_obj=np.asarray(PYDATETIME, dtype=int), _name='dt', _dump_options=['numpy'])
    dump(_obj=np.asarray(RADIOMETRY, dtype=np.float32), _name='bt', _dump_options=['numpy'])
    dump(_obj=np.asarray(LOCALMETEO, dtype=np.float32), _name='lm', _dump_options=['numpy'])
    dump(_obj=np.asarray(METEOSONDE, dtype=int), _name='ms', _dump_options=['numpy'])
    dump(_obj=np.asarray(SESSIONIDS, dtype=int), _name='id', _dump_options=['numpy'])

    dump(_obj=np.asarray(TIMESTAMPS), _name='ts', _dump_options=['dill'])
    dump(_obj=np.asarray(PYDATETIME, dtype=int), _name='dt', _dump_options=['dill'])
    dump(_obj=np.asarray(RADIOMETRY, dtype=np.float32), _name='bt', _dump_options=['dill'])
    dump(_obj=np.asarray(LOCALMETEO, dtype=np.float32), _name='lm', _dump_options=['dill'])
    dump(_obj=np.asarray(METEOSONDE, dtype=int), _name='ms', _dump_options=['dill'])
    dump(_obj=np.asarray(SESSIONIDS, dtype=int), _name='id', _dump_options=['dill'])
